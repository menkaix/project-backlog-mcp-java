...
public class MCPService {
    ...
    public String getListDiagrams(ToolContext toolContext) throws IOException {
    ...
    public String getDiagram(@ToolParam(description = "mongo id of the diagram") String id, ToolContext toolContext)
            throws IOException {
        return hyperManagerClient.get("/diagram/" + id);
    }

    @Tool(description = "get a lists of projects", name = "get-list-projects")
    public String getListProjects(ToolContext toolContext) throws IOException {
    ...
    public String getProjectsTree(@ToolParam(description = "project identifier") String project,
            ToolContext toolContext) throws IOException {
    ...
    public String getListFeatureTypes(ToolContext toolContext) throws IOException {
        return hyperManagerClient.get("/featuretypes");
    }

    @Tool(description = "Get the story tree by story ID", name = "get-story-tree")
    public String getStoryTree(@ToolParam(description = "ID of the story") String storyID, ToolContext toolContext)
            throws IOException {
    ...
    public String refreshFeatureTypes(ToolContext toolContext) throws IOException {
        return hyperManagerClient.get("/feature-command/refresh-types");
    }

    @Tool(description = "Normalize tasks", name = "normalize-tasks")
    public String normalizeTasks(ToolContext toolContext) throws IOException {
        return hyperManagerClient.get("/normalize-tasks");
    }

    @Tool(description = "Get a diagram definition", name = "get-diagram-definition")
    public String getDiagramDefinition(@ToolParam(description = "Name of the diagram") String name,
            ToolContext toolContext) throws IOException {
    ...
    public String updateDiagramGraphic(@ToolParam(description = "mongo id of the diagram") String diagramName,
            @ToolParam(description = "json body in the the updates") String request, ToolContext toolContext)
            throws IOException {
    ...
    public String updateStory(@ToolParam(description = "Story data to update") String request, ToolContext toolContext)
            throws IOException {
    ...
    public String addFeatureToStory(@ToolParam(description = "ID of the story") String story,
            @ToolParam(description = "Feature data to add") String request, ToolContext toolContext)
            throws IOException {
    ...
    public String addChildFeature(@ToolParam(description = "ID of the parent feature") String parent,
            @ToolParam(description = "Child feature data to add") String request, ToolContext toolContext)
            throws IOException {
    ...
    public String adoptChildFeature(@ToolParam(description = "ID of the parent feature") String parent,
            @ToolParam(description = "ID of the child feature") String child, ToolContext toolContext)
            throws IOException {
    ...
    public String addActor(@ToolParam(description = "ID of the project") String project,
            @ToolParam(description = "Actor data to add") String request, ToolContext toolContext) throws IOException {
    ...
    public String addStoryToActor(@ToolParam(description = "ID of the project") String project,
            ...
            @ToolParam(description = "Story data to add") String request, ToolContext toolContext) throws IOException {
    ...
    public String updateDiagramDefinition(@ToolParam(description = "Name of the diagram") String name,
            @ToolParam(description = "Diagram definition data") String request, ToolContext toolContext)
            throws IOException {
